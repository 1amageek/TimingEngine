...
public struct TimingCorpusCase: Sendable, Hashable, Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.init(
            ...
            engine: try container.decodeIfPresent(Engine.self, forKey: .engine) ?? .sta,
            description: try container.decodeIfPresent(String.self, forKey: .description) ?? "",
            expectedOutcome: try container.decode(TimingCorpusExpectedOutcome.self, forKey: .expectedOutcome),
            expectedDiagnosticCodes: try container.decodeIfPresent([String].self, forKey: .expectedDiagnosticCodes) ?? [],
            ...
            libraryPaths: try container.decodeIfPresent([String].self, forKey: .libraryPaths) ?? [],
